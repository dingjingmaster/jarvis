...
static void __move_json_value(json_value_t *src, json_value_t *dest)
{
    switch (src->type)
    {
        ...
        case JSON_VALUE_OBJECT:
            ...
            dest->value.object.root.rbNode = src->value.object.root.rbNode;
...
static int __set_json_value(int type, va_list ap, json_value_t *val)
{
    switch (type)
    {
        ...
        case JSON_VALUE_OBJECT:
            ...
            val->value.object.root.rbNode = NULL;
...
const json_value_t *json_array_next_value(const json_value_t *prev, const json_array_t *arr)
{
    struct list_head *pos;
    json_element_t *elem;
